...
public class SoundAgentSoccer : Agent
{
    ...
    SoundSoccerSettings m_SoccerSettings;
    ...
    public override void Initialize()
    {
       ...
       // Initialize the SoundSensor
        ...
        SoundSoccerEnvController envController = GetComponentInParent<SoundSoccerEnvController>();
        ...
        m_SoccerSettings = FindObjectOfType<SoundSoccerSettings>();
    ...
    public override void OnEpisodeBegin()
    {
        ...
        SoundSoccerBallController.ResetBallTouched();

        // Reset sound emitter for the ball
        var ballController = FindObjectOfType<SoundSoccerBallController>();
    ...
    {       
        ...
        Debug.Log($"Number of observations added: {sensor1.ObservationSize()}");

        // Add sound observations
        sensor1.AddObservation(soundSensor.SoundIntensity); // Intensity of the sound
        sensor1.AddObservation(soundSensor.SoundDirection.x);
        sensor1.AddObservation(soundSensor.SoundDirection.z);
        sensor1.AddObservation(soundSensor.RelativeVelocity.x);
        sensor1.AddObservation(soundSensor.RelativeVelocity.z);
    }
}
